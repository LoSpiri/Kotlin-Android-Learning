...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView dogAge, @NonNull TextView dogDescription, @NonNull ImageView dogImage,
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView dogDescription = rootView.findViewById(id);
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, dogAge,
          dogDescription, dogImage, dogName);
    }
